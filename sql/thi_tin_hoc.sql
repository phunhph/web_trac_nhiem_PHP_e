...
CREATE TABLE `allowexam` (
  ...
  `mamodun` varchar(20) NOT NULL,
  `allow` varchar(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `bode` (
  `mabode` varchar(20) NOT NULL,
  `tenbode` varchar(300) NOT NULL,
  `mamodun` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `cauhoi` (
  ...
  `tencauhoi` varchar(1100) NOT NULL,
  `padung` varchar(1000) NOT NULL,
  `pasai1` varchar(1000) NOT NULL,
  `pasai2` varchar(1000) NOT NULL,
  `pasai3` varchar(1000) NOT NULL,
  `imgviauTencauhoi` varchar(200) DEFAULT NULL,
  `imgviauPadung` varchar(200) DEFAULT NULL,
  `imgviauPasai1` varchar(200) DEFAULT NULL,
  `imgviauPasai2` varchar(200) DEFAULT NULL,
  `imgviauPasai3` varchar(200) DEFAULT NULL,
  `mucdo` varchar(40) NOT NULL,
  `mabode` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
('UI07-001', 'cau hoi 1', 'dung', 'sai', 'sai', 'sai', NULL, NULL, NULL, NULL, NULL, 'Trung bình', 'UI07'),
('UI07-002', 'cau hoi 2', 'dung', 'sai', 'sai', 'sai', NULL, NULL, NULL, NULL, NULL, 'Dễ', 'UI07'),
('UI07-003', 'cau hoi 3', 'dung', 'sai', 'sai', 'sai', NULL, NULL, NULL, NULL, NULL, 'Khó', 'UI07'),
('UI07-004', 'cau hoi 4', 'dung', 'sai', 'sai', 'sai', NULL, NULL, NULL, NULL, NULL, 'Trung bình', 'UI07');
...
CREATE TABLE `dethiprofile` (
  ...
  `cauhoi` varchar(20) DEFAULT NULL,
...
('MD02-1', 'UI07', 0, 1, 'MD02'),
('MD02-2', 'UI07', 2, 0, 'MD02'),
('MD02-3', 'UI07', 1, 2, 'MD02');
...
CREATE TABLE `dethisinh` (
  `sbd` varchar(20) NOT NULL,
  `macauhoi` varchar(20) NOT NULL,
  `socau` varchar(20) DEFAULT NULL,
  `padung` varchar(1000) NOT NULL,
  `pachon` varchar(1000) DEFAULT NULL,
  `temp` varchar(2) DEFAULT NULL,
  `mamodun` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `dethisinh` (`sbd`, `macauhoi`, `socau`, `padung`, `pachon`, `temp`, `mamodun`) VALUES
('03X0001', 'UI01-039', 'cau 13', 'D', NULL, NULL, 'MD01'),
('03X0001', 'UI01-048', 'cau 20', 'D', NULL, NULL, 'MD01'),
('03X0001', 'UI01-091', 'cau 25', 'A', NULL, NULL, 'MD01'),
('03X0001', 'UI01-120', 'cau 15', 'B', NULL, 'D', 'MD01'),
('03X0001', 'UI02-001', 'cau 01', 'D', NULL, 'A', 'MD01'),
('03X0001', 'UI02-041', 'cau 16', 'D', NULL, NULL, 'MD01'),
('03X0001', 'UI02-046', 'cau 21', 'B', NULL, 'D', 'MD01'),
('03X0001', 'UI02-093', 'cau 17', 'D', NULL, 'D', 'MD01'),
('03X0001', 'UI03-050', 'cau 22', 'B', NULL, 'B', 'MD01'),
('03X0001', 'UI03-056', 'cau 23', 'A', NULL, 'A', 'MD01'),
('03X0001', 'UI03-099', 'cau 10', 'B', NULL, 'C', 'MD01'),
('03X0001', 'UI03-101', 'cau 08', 'A', NULL, 'C', 'MD01'),
('03X0001', 'UI03-112', 'cau 19', 'B', NULL, NULL, 'MD01'),
('03X0001', 'UI04-032', 'cau 09', 'B', NULL, 'D', 'MD01'),
('03X0001', 'UI04-058', 'cau 05', 'B', NULL, 'D', 'MD01'),
('03X0001', 'UI04-067', 'cau 04', 'D', NULL, 'B', 'MD01'),
('03X0001', 'UI04-108', 'cau 07', 'A', NULL, 'C', 'MD01'),
('03X0001', 'UI05-007', 'cau 14', 'D', NULL, 'D', 'MD01'),
('03X0001', 'UI05-019', 'cau 24', 'A', NULL, NULL, 'MD01'),
('03X0001', 'UI05-094', 'cau 03', 'B', NULL, 'A', 'MD01'),
('03X0001', 'UI05-107', 'cau 06', 'B', NULL, NULL, 'MD01'),
('03X0001', 'UI06-004', 'cau 11', 'A', NULL, NULL, 'MD01'),
('03X0001', 'UI06-040', 'cau 12', 'C', NULL, 'B', 'MD01'),
('03X0001', 'UI06-062', 'cau 18', 'C', NULL, NULL, 'MD01'),
('03X0001', 'UI06-090', 'cau 02', 'A', NULL, 'D', 'MD01'),
('03X0001', 'UI07-001', 'cau 01', 'B', NULL, 'B', 'MD02'),
('03X0001', 'UI07-002', 'cau 03', 'B', NULL, 'B', 'MD02'),
('03X0001', 'UI07-004', 'cau 02', 'D', NULL, 'D', 'MD02');
...
('03X0001', 'MD01', 1.6, 4, '2024-03-05 08:31:57', 0, '2024-03-05 08:32:22'),
('03X0001', 'MD02', 10, 3, '2024-03-05 08:57:21', 0, '2024-03-05 08:57:28');
...
CREATE TABLE `donvi` (
  ...
  `tendonvi` varchar(300) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `hocvien` (
  ...
  `noisinh` varchar(300) DEFAULT NULL,
  `makythi` varchar(20) NOT NULL,
  `madonvi` varchar(20) NOT NULL,
  `tenphongthi` varchar(80) DEFAULT NULL,
...
('12X1233', 'Họ đệm', 'Tên', '29/03/2004', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '273c51e0ebce6994218218179012db7d', NULL),
('12X1234', 'Họ đệm', 'Tên', '29/03/2004', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '233263bf0eb10338a1fcf91b1e26ce27', NULL),
('12X1235', 'Họ đệm', 'Tên', '29/03/2004', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', 'f470318cedd4a20b2dbf1a2584b65762', NULL),
('12X1236', 'Họ đệm', 'Tên', '29/03/2004', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '4f644f8250d3a4287f3c231d7aa9b9e3', NULL),
('12X1237', 'Họ đệm', 'Tên', '29/03/2005', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '52bd3dee37361303ab73e9ab0776c332', NULL),
('12X1238', 'Họ đệm', 'Tên', '29/03/2006', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '67b407cb9be24d650b646952c8a7cb3f', NULL),
('12X1239', 'Họ đệm', 'Tên', '29/03/2007', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', 'd39bfa8483e18943d0b2872d74a332f8', NULL),
('12X1240', 'Họ đệm', 'Tên', '29/03/2008', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '4109b20f1c9ed1ded7f49bd191edb9e8', NULL),
('12X1241', 'Họ đệm', 'Tên', '29/03/2009', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '786e20af53164eeba797feeb52ac4802', NULL),
('12X1242', 'Họ đệm', 'Tên', '29/03/2010', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '1f4a0f392765e72f1d9293c254ed0997', NULL),
('12X1243', 'Họ đệm', 'Tên', '29/03/2011', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '5c4d5413b27e34da2b219fb0ec8326cf', NULL),
('12X1244', 'Họ đệm', 'Tên', '29/03/2012', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', 'a0c21693a49f47b5f62560e0b7c93ff1', NULL),
('12X1245', 'Họ đệm', 'Tên', '29/03/2013', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', 'fd1fe52be9b94cdd3e66d10ca05130eb', NULL),
('12X1246', 'Họ đệm', 'Tên', '29/03/2014', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '237061fe44e43644a3a76393283ff822', NULL),
('12X1247', 'Họ đệm', 'Tên', '29/03/2015', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '835ae4b00e551efc632c1ae36a75c1f4', NULL),
('12X1248', 'Họ đệm', 'Tên', '29/03/2016', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', 'c38da388e14d0ff726231849b6c466fb', NULL),
('12X1249', 'Họ đệm', 'Tên', '29/03/2017', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '1ad4a09a9e430bfa3ce6df73bf5f04bf', NULL),
('12X1250', 'Họ đệm', 'Tên', '29/03/2018', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '641081854a08a9514d90cedc499e6a41', NULL),
('12X1251', 'Họ đệm', 'Tên', '29/03/2019', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '44ac2a7864cb4869b51b692aa90fe0b9', NULL),
('12X1252', 'Họ đệm', 'Tên', '29/03/2020', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '74180b9623501219f7b5aadb6ee8406b', NULL),
('12X1253', 'Họ đệm', 'Tên', '29/03/2021', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '2dafe86d3e617a8da9fc78f0e0dd4526', NULL),
('12X1254', 'Họ đệm', 'Tên', '29/03/2022', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', 'd7b44ff6e1980a8cde062c3aee35dd4e', NULL),
('12X1255', 'Họ đệm', 'Tên', '29/03/2023', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '7efbc8b0e6a28211b5501f75a9b0fafc', NULL),
('12X1256', 'Họ đệm', 'Tên', '29/03/2024', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '73c990323c2e97f9ff9dbd8153a7d1c7', NULL),
('12X1257', 'Họ đệm', 'Tên', '29/03/2025', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', 'f4c20c122ce346d8031345149a60cb4a', NULL),
('12X1258', 'Họ đệm', 'Tên', '29/03/2026', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', 'fec14e8d6e16a781aefe6dd55c37aa46', NULL),
('12X1259', 'Họ đệm', 'Tên', '29/03/2027', 'Hà Nội', 'KT001', 'SS', 'Phòng 1', '77ddc88fc11bc9203bfb33509deaad28', NULL),
('12X1260', 'Họ đệm', 'Tên', '29/03/2028', 'Hà Nội', 'KT001', 'SS', 'Phòng 2', '7050cf14879a3a6b7e7a68aaa4a6f6fe', NULL),
('12X1261', 'Họ đệm', 'Tên', '29/03/2029', 'Hà Nội', 'KT001', 'SS', 'Phòng 2', 'b40a98bd81175f83749e4d6772417b87', NULL),
('12X1262', 'Họ đệm', 'Tên', '29/03/2030', 'Hà Nội', 'KT001', 'SS', 'Phòng 2', '8c934ee80767476b73b6eb601fab2ed2', NULL),
('12X1263', 'Họ đệm', 'Tên', '29/03/2031', 'Hà Nội', 'KT001', 'SS', 'Phòng 2', '1e03084323617e0532d9a6f77f10f5f1', NULL),
('12X1264', 'Họ đệm', 'Tên', '29/03/2032', 'Hà Nội', 'KT001', 'SS', 'Phòng 2', '9a080dd7df5d29e3c56988f6f7c7a775', NULL),
('12X1265', 'Họ đệm', 'Tên', '29/03/2033', 'Hà Nội', 'KT001', 'SS', 'Phòng 2', '77cb43bafd27fc83b0186209591d90ec', NULL),
('12X1266', 'Họ đệm', 'Tên', '29/03/2034', 'Hà Nội', 'KT001', 'SS', 'Phòng 2', '465aaf34df31ec1afce030df52257d64', NULL);
...
(1, '03X0001', 'N9787637'),
(195, '12X1233', 'N0996773'),
(196, '12X1234', 'N6174451'),
(197, '12X1235', 'N5955038'),
(198, '12X1236', 'N5738545'),
(199, '12X1237', 'N4770795'),
(200, '12X1238', 'N5644487'),
(201, '12X1239', 'N9783786'),
(202, '12X1240', 'N9352427'),
(203, '12X1241', 'N6202736'),
(204, '12X1242', 'N9256885'),
(205, '12X1243', 'N8555197'),
(206, '12X1244', 'N3908937'),
(207, '12X1245', 'N5850005'),
(208, '12X1246', 'N8130645'),
(209, '12X1247', 'N3592496'),
(210, '12X1248', 'N9624235'),
(211, '12X1249', 'N9966679'),
(212, '12X1250', 'N3866228'),
(213, '12X1251', 'N4065530'),
(214, '12X1252', 'N7538972'),
(215, '12X1253', 'N9754402'),
(216, '12X1254', 'N2259736'),
(217, '12X1255', 'N6830260'),
(218, '12X1256', 'N4779089'),
(219, '12X1257', 'N6637127'),
(220, '12X1258', 'N6716048'),
(221, '12X1259', 'N8661988'),
(222, '12X1260', 'N1595339'),
(223, '12X1261', 'N6955531'),
(224, '12X1262', 'N8566951'),
(225, '12X1263', 'N3485229'),
(226, '12X1264', 'N4299730'),
(227, '12X1265', 'N4879077'),
(228, '12X1266', 'N5534076');
...
('MD01', 'Tin học 1', '2016-03-11 06:00:00', '2017-03-11 10:00:00', 'KT001'),
('MD02', 'Tin học 2', '2016-03-11 06:00:00', '2017-03-11 10:00:00', 'KT001');
...
('03X0001', 'MD01', '::1', 'Đã thi xong'),
('03X0001', 'MD02', '::1', 'Đã thi xong');
