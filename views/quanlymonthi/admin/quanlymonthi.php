                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" id="suamodun">
                                                        <div class="row">
                                                            <div class="mb-9 col-lg-9 col-md-9 col-sm-9 csbd">
                                                            ...
                                                            <div class="mb-3 col-lg-3 col-md-3 col-sm-3 csbd">
                                                                <label class="form-label h5 fw-bolder">Loại</label>
                                                                <div class="d-flex justify-content-between align-items-center border-dark-subtle">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" id="nam" name="loai" value="bt">
                                                                        <label class="form-check-label" for="nam">Cơ
                                                                            bản</label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" id="nu" name="loai" value="ta">
                                                                        <label class="form-check-label" for="nu">Tiếng
                                                                            anh</label>
                                                                    </div>
                                                                </div>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <button type="button" class="btn btn-warning " data-bs-toggle="modal" data-bs-target="#exampleModal01">
                                            THÊM MỚI
                                        </button>
                                    </div>
