...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Soạn đề thi tiếng anh</h1>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-2 row">
                                <div class="mb-3 col-lg-3 col-md-3 col-sm-3">
                                    <label class="form-label h6 fw-bolder">Phần thi</label>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <button class="btn btn-outline-success" id="GA">Ngữ pháp</button>
                                        <button class="btn btn-outline-success" id="LI">Nghe</button>
                                        <button class="btn btn-outline-success" id="RE">Đọc</button>
                                    </div>
                                </div>
                                <!-- <div class="mb-9 col-lg-9 col-md-9 col-sm-9">
                    ...
                    <div class="card shadow mt-3">
                        <div class="card-body">
                                            ...
                                            <form name="update" id="update" class="w-100 text-black g-3" method="POST"
                                                ...
                                                <div class="row ">
                                                    ...
                                                    <div class="mb-12 col-lg-7 col-md-7 col-sm-7 col-xs-12 ">
                                                        ...
                                                        <input type="text" name="tencauhoi" id="tencauhoi"
                                                            class="form-control text-dark border-dark-subtle" value="">
                                                    </div>
                                                    ...
                                                    <div class="mb-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                                        <div class="custom-file w-100 mt-2">
                                                            ...
                                                            <label class="custom-file-label" for="file1">Thêm hình ảnh,
                                                                âm thanh hoặc video <i
                                                                    class="fas fa-upload ml-1"></i></label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="mb-12 col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                                                        ...
                                                        <input type="text" name="padung" id="padung"
                                                            class="form-control text-dark border-dark-subtle" value="">
                                                        <div class="custom-file w-100 mt-2">
                                                    ...
                                                    <div class="mb-12 col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                                                        ...
                                                        <input type="text" name="pasai1" id="pasai1"
                                                            class="form-control text-dark border-dark-subtle" value="">
                                                        <div class="custom-file w-100 mt-2">
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="mb-12 col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                                                        ...
                                                        <input type="text" name="pasai2" id="pasai2"
                                                            class="form-control text-dark border-dark-subtle" value="">
                                                        <div class="custom-file w-100 mt-2">
                                                    ...
                                                    <div class="mb-12 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <input type="text" name="pasai3" id="pasai3"
                                                            class="form-control text-dark border-dark-subtle" value="">
                                                        <div class="custom-file w-100 mt-2">
                            ...
                            <div class="table-responsive" id="loadndch">
                                <form method="post" action="" name='t'>
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th style='width:7%;'>STT</th>
                                                <th style='width:30%;'>Nội dung bài đọc</th>
                                ...
                                <form method="post" action="" name='r'>
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th style='width:7%;'>STT</th>
                                                <th style='width:30%;'>Nội dung bài nghe</th>
                                                <th style='width:10%;'>Mức độ</th>
                                                <th style='width:10%;'>Trạng thái</th>
                                                <th style='width:5%;'>Chi tiết</th>
                                            </tr>
                    ...
                    <div class="card shadow mt-3">
                        <div class="card-body">
                            ...
                            <form id="upcauhoi" class="row d-flex justify-content-center" method="post"
                                enctype="multipart/form-data" style="margin-top:-2.6em;">
    ...
    <script src="assets/js/tapdethibienthe.js"></script>
